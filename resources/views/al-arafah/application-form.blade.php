                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <input class="form-control" placeholder="" name="dob" type="date"
                                                       id="payment_due_at" value="" required>
                                                <!-- <div class="input-group date">
                                        ...
                                        <div class="form-group row mb-0">
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="">
                                                    <input type="file" name="personal_image" alt="personal_image"
                                                           required>
                                            ...
                                            <div class="col-lg-9 mb-3">
                                                ...
                                                <div class="">
                                                    <input type="file" name="customer_nid" alt="personal_image"
                                                           required>
                                                </div>
                                                <span class="form-text text-muted">Max file size is 1MB and max number of files is 5.</span>
                                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder=" "
                                                   name="nominee_1_nid_no">
                                        </div>

                                        <div class="col-lg-6 mb-3">
                                            <label>Relations * </label>
                                            <input type="text" class="form-control" placeholder=" "
                                                   name="nominee_1_relation">
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label>Percentage * </label>
                                            <input type="text" class="form-control" placeholder=" "
                                                   name="nominee_1_percentage">
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <div class="">
                                                <input type="file" name="utility_image">
                                            </div>
                                            <span class="form-text text-muted">Max file size is 1MB and max number of files is 5.</span>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            <div class="col-lg-12 text-right">
                                                <a href="verified-view.html">
                                                    <button type="" class="btn btn-primary mr-2">Submit</button>
                                                </a>
                                                <button id="btn-error" type="reset" class="btn btn-secondary">Cancel
                                                </button>
                                            </div>
                                        </div>
                                    </div>
