                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-center"><strong>Approved List</strong></h4>
                                <hr class="m-3">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="table-responsive" style="width:100%">
                                        <table id="approved-application-table"
...
@push('custom-js')
    <script>
        const form_builder = new Vue({
            ...
            methods: {
                dataTableInit() {
                    this.dataTable = $('#approved-application-table').DataTable({
                        processing: true,
                        // serverSide: true,
                        ...
                        columns: [
                            ...
                            },
                            {
                                className: 'all',
                                orderable: true,
                                data: 'form_id', render(data, type, row) {
            ...
            mounted() {
                this.dataTableInit({});
                const that = this;
                $('#approved-application-table tbody').on('click', '.view_form', function () {
                    that.reset();
                    that.mode = 'edit';
